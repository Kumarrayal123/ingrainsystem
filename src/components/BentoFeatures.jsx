      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="mb-20">
          <motion.h3
            ...
            viewport={{ once: true }}
            className="text-xs font-bold text-gray-500 tracking-[0.2em] uppercase mb-4 block"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-auto md:auto-rows-[300px]">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="md:col-span-2 bg-[#111113] rounded-[1.8rem] p-8 flex flex-col justify-between border border-white/5 relative overflow-hidden group hover:border-white/20 transition-colors duration-500"
          >
          ...
          <motion.div
            ...
            className="bg-[#111113] rounded-[1.8rem] p-8 flex flex-col justify-between border border-white/5 relative overflow-hidden group hover:border-white/20 transition-colors duration-500"
          >
            <div className="relative z-10">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, scale: 1 }}
            viewport={{ once: true, margin: "-50px" }}
            className="md:col-span-3 bg-[#111113] rounded-[1.8rem] p-8 flex flex-col justify-center items-center text-center border border-white/5 relative overflow-hidden group hover:border-white/20 transition-colors duration-500"
          >
