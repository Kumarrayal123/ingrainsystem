...
// Reuse the same PricingTier component from Price page for consistency
...
const HowItWorks = () => {
  ...
  useEffect(() => {
    // Fetch plans from the API – reuse same endpoint as Price page
  ...
  return (
    <main className="bg-black text-white h-screen overflow-y-auto snap-y snap-mandatory scroll-smooth font-sans selection:bg-blue-500/30 no-scrollbar">
      <style jsx>{`
      ...
      <div className="fixed inset-0 z-0">
        ...
        <div className="absolute bottom-[-10%] right-[-10%] w-[800px] h-[800px] bg-indigo-600/10 rounded-full blur-[180px]" />
      </div>

      {/* Hero – mirrors Price page hero but with How It Works wording */}
      <section className="snap-start h-screen w-full flex flex-col items-center justify-center px-6 text-center relative overflow-hidden">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-400 font-light max-w-3xl mx-auto mb-12">
            Discover the workflow that powers seamless HR & recruitment for your business.
          </p>
        </motion.div>
      </section>

      {/* Desktop grid of tiers */}
